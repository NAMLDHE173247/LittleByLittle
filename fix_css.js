...
const idx = text.indexOf('/* Nghia column fixed width */');

if (idx !== -1) {
  const goodText = text.slice(0, idx) + '/* Nghia column fixed width */\n.col-meanings { width: 8cm; min-width: 8cm; max-width: 8cm; white-space: normal; word-wrap: break-word; }\n\n';
  const newCss = `
...
`;
  fs.writeFileSync('client/src/App.css', goodText + newCss, 'utf8');
